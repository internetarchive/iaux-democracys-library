 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ge=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}};function P(s){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(s,e,t):Ge(s,e)}/**
 * @license
 ...
 */function*Xe(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}let D=class extends ${constructor(){super(...arguments),this.src="",this.alt=""}render(){return f`
  ...
  `;se=y([C("welcome-header")],se);const X={link:"https://webservices.archive.org/wgw/",linkText:"Government websites of the world"};let E=class extends ${constructor(){super(...arguments),this.carousel1=it,this.didYouKnow=ot,this.highlights=et,this.availableResources=void 0}firstUpdated(){this.fetchAvailableResources();const e=document.createElement("style");e.innerHTML=`
    ...
    /* End Carousel */
  `;y([P({type:Array})],E.prototype,"carousel1",void 0);y([P({type:Array})],E.prototype,"didYouKnow",void 0);y([P({type:Array})],E.prototype,"highlights",void 0);y([P({type:Object})],E.prototype,"availableResources",void 0);E=y([C("ia-democracys-library")],E);let re=class extends ${render(){return f`
