const Ue=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}};Ue();function y(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var c=s.length-1;c>=0;c--)(n=s[c])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const j=window,ne=j.ShadowRoot&&(j.ShadyCSS===void 0||j.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,le=Symbol(),de=new WeakMap;class we{constructor(e,t,i){if(this._$cssResult$=!0,i!==le)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ne&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=de.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&de.set(t,e))}return e}toString(){return this.cssText}}const Le=s=>new we(typeof s=="string"?s:s+"",void 0,le),S=(s,...e)=>{const t=s.length===1?s[0]:e.reduce((i,o,r)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+s[r+1],s[0]);return new we(t,s,le)},Me=(s,e)=>{ne?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),o=j.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=t.cssText,s.appendChild(i)})},he=ne?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return Le(t)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var V;const W=window,ue=W.trustedTypes,Ie=ue?ue.emptyScript:"",pe=W.reactiveElementPolyfillSupport,ee={toAttribute(s,e){switch(e){case Boolean:s=s?Ie:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},ke=(s,e)=>e!==s&&(e==e||s==s),K={attribute:!0,type:String,converter:ee,reflect:!1,hasChanged:ke};class O extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;(t=this.h)!==null&&t!==void 0||(this.h=[]),this.h.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const o=this._$Ep(i,t);o!==void 0&&(this._$Ev.set(o,i),e.push(o))}),e}static createProperty(e,t=K){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,i,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(o){const r=this[e];this[t]=o,this.requestUpdate(e,r,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||K}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of i)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const o of i)t.unshift(he(o))}else e!==void 0&&t.push(he(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Me(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=K){var o;const r=this.constructor._$Ep(e,i);if(r!==void 0&&i.reflect===!0){const n=(((o=i.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?i.converter:ee).toAttribute(t,i.type);this._$El=e,n==null?this.removeAttribute(r):this.setAttribute(r,n),this._$El=null}}_$AK(e,t){var i;const o=this.constructor,r=o._$Ev.get(e);if(r!==void 0&&this._$El!==r){const n=o.getPropertyOptions(r),c=typeof n.converter=="function"?{fromAttribute:n.converter}:((i=n.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?n.converter:ee;this._$El=r,this[r]=c.fromAttribute(t,n.type),this._$El=null}}requestUpdate(e,t,i){let o=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||ke)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,r)=>this[r]=o),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var r;return(r=o.hostUpdate)===null||r===void 0?void 0:r.call(o)}),this.update(i)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var o;return(o=i.hostUpdated)===null||o===void 0?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}O.finalized=!0,O.elementProperties=new Map,O.elementStyles=[],O.shadowRootOptions={mode:"open"},pe==null||pe({ReactiveElement:O}),((V=W.reactiveElementVersions)!==null&&V!==void 0?V:W.reactiveElementVersions=[]).push("1.4.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Y;const G=window,H=G.trustedTypes,me=H?H.createPolicy("lit-html",{createHTML:s=>s}):void 0,A=`lit$${(Math.random()+"").slice(9)}$`,ae="?"+A,Be=`<${ae}>`,P=document,M=(s="")=>P.createComment(s),I=s=>s===null||typeof s!="object"&&typeof s!="function",Ee=Array.isArray,Se=s=>Ee(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ge=/-->/g,ve=/>/g,x=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),fe=/'/g,ye=/"/g,Ce=/^(?:script|style|textarea|title)$/i,De=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),f=De(1),k=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),$e=new WeakMap,R=P.createTreeWalker(P,129,null,!1),Te=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",n=U;for(let a=0;a<t;a++){const l=s[a];let v,h,d=-1,u=0;for(;u<l.length&&(n.lastIndex=u,h=n.exec(l),h!==null);)u=n.lastIndex,n===U?h[1]==="!--"?n=ge:h[1]!==void 0?n=ve:h[2]!==void 0?(Ce.test(h[2])&&(o=RegExp("</"+h[2],"g")),n=x):h[3]!==void 0&&(n=x):n===x?h[0]===">"?(n=o!=null?o:U,d=-1):h[1]===void 0?d=-2:(d=n.lastIndex-h[2].length,v=h[1],n=h[3]===void 0?x:h[3]==='"'?ye:fe):n===ye||n===fe?n=x:n===ge||n===ve?n=U:(n=x,o=void 0);const p=n===x&&s[a+1].startsWith("/>")?" ":"";r+=n===U?l+Be:d>=0?(i.push(v),l.slice(0,d)+"$lit$"+l.slice(d)+A+p):l+A+(d===-2?(i.push(void 0),a):p)}const c=r+(s[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return[me!==void 0?me.createHTML(c):c,i]};class B{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,n=0;const c=e.length-1,a=this.parts,[l,v]=Te(e,t);if(this.el=B.createElement(l,i),R.currentNode=this.el.content,t===2){const h=this.el.content,d=h.firstChild;d.remove(),h.append(...d.childNodes)}for(;(o=R.nextNode())!==null&&a.length<c;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const d of o.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(A)){const u=v[n++];if(h.push(d),u!==void 0){const p=o.getAttribute(u.toLowerCase()+"$lit$").split(A),m=/([.?@])?(.*)/.exec(u);a.push({type:1,index:r,name:m[2],strings:p,ctor:m[1]==="."?Re:m[1]==="?"?He:m[1]==="@"?Pe:z})}else a.push({type:6,index:r})}for(const d of h)o.removeAttribute(d)}if(Ce.test(o.tagName)){const h=o.textContent.split(A),d=h.length-1;if(d>0){o.textContent=H?H.emptyScript:"";for(let u=0;u<d;u++)o.append(h[u],M()),R.nextNode(),a.push({type:2,index:++r});o.append(h[d],M())}}}else if(o.nodeType===8)if(o.data===ae)a.push({type:2,index:r});else{let h=-1;for(;(h=o.data.indexOf(A,h+1))!==-1;)a.push({type:7,index:r}),h+=A.length-1}r++}}static createElement(e,t){const i=P.createElement("template");return i.innerHTML=e,i}}function E(s,e,t=s,i){var o,r,n,c;if(e===k)return e;let a=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const l=I(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==l&&((r=a==null?void 0:a._$AO)===null||r===void 0||r.call(a,!1),l===void 0?a=void 0:(a=new l(s),a._$AT(s,t,i)),i!==void 0?((n=(c=t)._$Co)!==null&&n!==void 0?n:c._$Co=[])[i]=a:t._$Cl=a),a!==void 0&&(e=E(s,a._$AS(s,e.values),a,i)),e}class Oe{constructor(e,t){this.u=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:P).importNode(i,!0);R.currentNode=r;let n=R.nextNode(),c=0,a=0,l=o[0];for(;l!==void 0;){if(c===l.index){let v;l.type===2?v=new N(n,n.nextSibling,this,e):l.type===1?v=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(v=new Ne(n,this,e)),this.u.push(v),l=o[++a]}c!==(l==null?void 0:l.index)&&(n=R.nextNode(),c++)}return r}p(e){let t=0;for(const i of this.u)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class N{constructor(e,t,i,o){var r;this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cm=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cm}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=E(this,e,t),I(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==k&&this.g(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Se(e)?this.k(e):this.g(e)}O(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}g(e){this._$AH!==g&&I(this._$AH)?this._$AA.nextSibling.data=e:this.T(P.createTextNode(e)),this._$AH=e}$(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=B.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.p(i);else{const n=new Oe(r,this),c=n.v(this.options);n.p(i),this.T(c),this._$AH=n}}_$AC(e){let t=$e.get(e.strings);return t===void 0&&$e.set(e.strings,t=new B(e)),t}k(e){Ee(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new N(this.O(M()),this.O(M()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cm=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class z{constructor(e,t,i,o,r){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=g}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let n=!1;if(r===void 0)e=E(this,e,t,0),n=!I(e)||e!==this._$AH&&e!==k,n&&(this._$AH=e);else{const c=e;let a,l;for(e=r[0],a=0;a<r.length-1;a++)l=E(this,c[i+a],t,a),l===k&&(l=this._$AH[a]),n||(n=!I(l)||l!==this._$AH[a]),l===g?e=g:e!==g&&(e+=(l!=null?l:"")+r[a+1]),this._$AH[a]=l}n&&!o&&this.j(e)}j(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Re extends z{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===g?void 0:e}}const ze=H?H.emptyScript:"";class He extends z{constructor(){super(...arguments),this.type=4}j(e){e&&e!==g?this.element.setAttribute(this.name,ze):this.element.removeAttribute(this.name)}}class Pe extends z{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=E(this,e,t,0))!==null&&i!==void 0?i:g)===k)return;const o=this._$AH,r=e===g&&o!==g||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==g&&(o===g||r);r&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ne{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){E(this,e)}}const je={P:"$lit$",A,M:ae,C:1,L:Te,R:Oe,D:Se,V:E,I:N,H:z,N:He,U:Pe,B:Re,F:Ne},be=G.litHtmlPolyfillSupport;be==null||be(B,N),((Y=G.litHtmlVersions)!==null&&Y!==void 0?Y:G.litHtmlVersions=[]).push("2.4.0");const We=(s,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let n=r._$litPart$;if(n===void 0){const c=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=n=new N(e.insertBefore(M(),c),c,void 0,t!=null?t:{})}return n._$AI(s),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var J,q;class $ extends O{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=We(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return k}}$.finalized=!0,$._$litElement$=!0,(J=globalThis.litElementHydrateSupport)===null||J===void 0||J.call(globalThis,{LitElement:$});const Ae=globalThis.litElementPolyfillSupport;Ae==null||Ae({LitElement:$});((q=globalThis.litElementVersions)!==null&&q!==void 0?q:globalThis.litElementVersions=[]).push("3.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ge=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}};function T(s){return(e,t)=>t!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(s,e,t):Ge(s,e)}/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ve=s=>(...e)=>({_$litDirective$:s,values:e});class Ke{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Ye}=je,_e=()=>document.createComment(""),L=(s,e,t)=>{var i;const o=s._$AA.parentNode,r=e===void 0?s._$AB:e._$AA;if(t===void 0){const n=o.insertBefore(_e(),r),c=o.insertBefore(_e(),r);t=new Ye(n,c,s,s.options)}else{const n=t._$AB.nextSibling,c=t._$AM,a=c!==s;if(a){let l;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(l=s._$AU)!==c._$AU&&t._$AP(l)}if(n!==r||a){let l=t._$AA;for(;l!==n;){const v=l.nextSibling;o.insertBefore(l,r),l=v}}}return t},w=(s,e,t=s)=>(s._$AI(e,t),s),Je={},qe=(s,e=Je)=>s._$AH=e,Ze=s=>s._$AH,Q=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xe=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},Qe=Ve(class extends Ke{constructor(s){if(super(s),s.type!==Fe.CHILD)throw Error("repeat() can only be used in text expressions")}ht(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const c of s)o[n]=i?i(c,n):n,r[n]=t(c,n),n++;return{values:r,keys:o}}render(s,e,t){return this.ht(s,e,t).values}update(s,[e,t,i]){var o;const r=Ze(s),{values:n,keys:c}=this.ht(e,t,i);if(!Array.isArray(r))return this.ut=c,n;const a=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],l=[];let v,h,d=0,u=r.length-1,p=0,m=n.length-1;for(;d<=u&&p<=m;)if(r[d]===null)d++;else if(r[u]===null)u--;else if(a[d]===c[p])l[p]=w(r[d],n[p]),d++,p++;else if(a[u]===c[m])l[m]=w(r[u],n[m]),u--,m--;else if(a[d]===c[m])l[m]=w(r[d],n[m]),L(s,l[m+1],r[d]),d++,m--;else if(a[u]===c[p])l[p]=w(r[u],n[p]),L(s,r[d],r[u]),u--,p++;else if(v===void 0&&(v=xe(c,p,m),h=xe(a,d,u)),v.has(a[d]))if(v.has(a[u])){const b=h.get(c[p]),F=b!==void 0?r[b]:null;if(F===null){const ce=L(s,r[d]);w(ce,n[p]),l[p]=ce}else l[p]=w(F,n[p]),L(s,r[d],F),r[b]=null;p++}else Q(r[u]),u--;else Q(r[d]),d++;for(;p<=m;){const b=L(s,l[m+1]);w(b,n[p]),l[p++]=b}for(;d<=u;){const b=r[d++];b!==null&&Q(b)}return this.ut=c,qe(s,l),k}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Xe(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}let D=class extends ${constructor(){super(...arguments),this.src="",this.alt=""}render(){return f`
      <div>
  ...
  `;se=y([C("welcome-header")],se);const X={link:"https://webservices.archive.org/wgw/",linkText:"Government websites of the world"};let _=class extends ${constructor(){super(...arguments),this.carousel1=it,this.didYouKnow=ot,this.highlights=et,this.analytics=void 0,this.availableResources=void 0}firstUpdated(){this.fetchAvailableResources();const e=document.createElement("style");e.innerHTML=`
    @font-face {
      font-family: "Teko";
        ...
        <dl-article tabindex="0">
          ...
          <div class="factoid-link">
            <a
              ...
              @click=${()=>{var i;(i=this.analytics)===null||i===void 0||i.send_event("DemocracysLibrary","FactoidLinkClicked",e.link)}}
              >${e.linkText}</a
            >
          </div>
        </dl-article>
      ...
      <dl-article tabindex="0">
        ...
        <a
          ...
          @click=${()=>{var i;(i=this.analytics)===null||i===void 0||i.send_event("DemocracysLibrary","ResourceCardItemImageClick",e.id)}}
        >
          <item-preview-image
            src=${e.image}
            class=${t!=null?t:""}
        ...
        <a
          ...
          href=${e.link}
          tab="_blank"
          @click=${()=>{var i;(i=this.analytics)===null||i===void 0||i.send_event("DemocracysLibrary","ResourceCardCollectionLinkClick",e.link)}}
    ...
    `}carouselCard(e,t){const i=`https://archive.org/details/${e.id}`;return f`
      <a
        ...
        @click=${()=>{var o;(o=this.analytics)===null||o===void 0||o.send_event("DemocracysLibrary","CaroselCardClick",e.id)}}
      >
        <item-preview-image
          src=${e.image}
          class=${t!=null?t:""}
    ...
    `}get resourcesOptions(){var e;const t=Object.keys((e=this.availableResources)!==null&&e!==void 0?e:{});return f`
      ...
      ${Qe(t,i=>i,i=>{var o,r;const n=(r=(o=this.availableResources)===null||o===void 0?void 0:o[i])!==null&&r!==void 0?r:[];return f`
          ...
          `})}
    `}resourceSelected(e){var t;const i=(e==null?void 0:e.target).value;(t=this.analytics)===null||t===void 0||t.send_event("DemocracysLibrary","ResourceSelected",i),window.location.href=i}render(){return f`
          ...
          <dl-article tabindex="0">
            ...
            <div id="resources-options">
              ...
              <a
                ...
                href=${X.link}
                @click=${()=>{var e;(e=this.analytics)===null||e===void 0||e.send_event("DemocracysLibrary","AitGovWorldSites",X.link)}}
                >${X.linkText}</a
              >
            </div>
          </dl-article>
    ...
    /* End Carousel */
  `;y([T({type:Array})],_.prototype,"carousel1",void 0);y([T({type:Array})],_.prototype,"didYouKnow",void 0);y([T({type:Array})],_.prototype,"highlights",void 0);y([T({type:Object})],_.prototype,"analytics",void 0);y([T({type:Object})],_.prototype,"availableResources",void 0);_=y([C("ia-democracys-library")],_);let re=class extends ${render(){return f`
      <div class="match-ia-coll-margins">
        <ia-democracys-library>
          ${this.dummyActionBarTemplate}
        </ia-democracys-library>
      </div>
    `}get dummyActionBarTemplate(){return f`
      <div slot="action-bar-section">
    ...
    `}dummyActionButtonTemplate(e,t){return f`
      <button
        class="action-bar-button"
        @click=${()=>alert("Not implemented in demo app")}
      >
        <span class="icon ${t}"></span> ${e}
      </button>
    `}};re.styles=S`
    :host {
      display: block;
