 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var K;const O=globalThis.trustedTypes,de=O?O.createPolicy("lit-html",{createHTML:s=>s}):void 0,A=`lit$${(Math.random()+"").slice(9)}$`,se="?"+A,Ue=`<${se}>`,H=document,L=(s="")=>H.createComment(s),I=s=>s===null||typeof s!="object"&&typeof s!="function",_e=Array.isArray,we=s=>{var e;return _e(s)||typeof((e=s)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,he=/-->/g,pe=/>/g,_=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,ue=/'/g,ge=/"/g,xe=/^(?:script|style|textarea|title)$/i,Me=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),f=Me(1),x=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),me=new WeakMap,Le=(s,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let n=r._$litPart$;if(n===void 0){const c=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=n=new P(e.insertBefore(L(),c),c,void 0,t!=null?t:{})}return n._$AI(s),n},R=H.createTreeWalker(H,129,null,!1),Ee=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",n=U;for(let l=0;l<t;l++){const a=s[l];let v,h,d=-1,p=0;for(;p<a.length&&(n.lastIndex=p,h=n.exec(a),h!==null);)p=n.lastIndex,n===U?h[1]==="!--"?n=he:h[1]!==void 0?n=pe:h[2]!==void 0?(xe.test(h[2])&&(o=RegExp("</"+h[2],"g")),n=_):h[3]!==void 0&&(n=_):n===_?h[0]===">"?(n=o!=null?o:U,d=-1):h[1]===void 0?d=-2:(d=n.lastIndex-h[2].length,v=h[1],n=h[3]===void 0?_:h[3]==='"'?ge:ue):n===ge||n===ue?n=_:n===he||n===pe?n=U:(n=_,o=void 0);const u=n===_&&s[l+1].startsWith("/>")?" ":"";r+=n===U?a+Ue:d>=0?(i.push(v),a.slice(0,d)+"$lit$"+a.slice(d)+A+u):a+A+(d===-2?(i.push(void 0),l):u)}const c=r+(s[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return[de!==void 0?de.createHTML(c):c,i]};class B{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,n=0;const c=e.length-1,l=this.parts,[a,v]=Ee(e,t);if(this.el=B.createElement(a,i),R.currentNode=this.el.content,t===2){const h=this.el.content,d=h.firstChild;d.remove(),h.append(...d.childNodes)}for(;(o=R.nextNode())!==null&&l.length<c;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const d of o.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(A)){const p=v[n++];if(h.push(d),p!==void 0){const u=o.getAttribute(p.toLowerCase()+"$lit$").split(A),g=/([.?@])?(.*)/.exec(p);l.push({type:1,index:r,name:g[2],strings:u,ctor:g[1]==="."?Ce:g[1]==="?"?ke:g[1]==="@"?Te:z})}else l.push({type:6,index:r})}for(const d of h)o.removeAttribute(d)}if(xe.test(o.tagName)){const h=o.textContent.split(A),d=h.length-1;if(d>0){o.textContent=O?O.emptyScript:"";for(let p=0;p<d;p++)o.append(h[p],L()),R.nextNode(),l.push({type:2,index:++r});o.append(h[d],L())}}}else if(o.nodeType===8)if(o.data===se)l.push({type:2,index:r});else{let h=-1;for(;(h=o.data.indexOf(A,h+1))!==-1;)l.push({type:7,index:r}),h+=A.length-1}r++}}static createElement(e,t){const i=H.createElement("template");return i.innerHTML=e,i}}function E(s,e,t=s,i){var o,r,n,c;if(e===x)return e;let l=i!==void 0?(o=t._$Cl)===null||o===void 0?void 0:o[i]:t._$Cu;const a=I(e)?void 0:e._$litDirective$;return(l==null?void 0:l.constructor)!==a&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),a===void 0?l=void 0:(l=new a(s),l._$AT(s,t,i)),i!==void 0?((n=(c=t)._$Cl)!==null&&n!==void 0?n:c._$Cl=[])[i]=l:t._$Cu=l),l!==void 0&&(e=E(s,l._$AS(s,e.values),l,i)),e}class Se{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:H).importNode(i,!0);R.currentNode=r;let n=R.nextNode(),c=0,l=0,a=o[0];for(;a!==void 0;){if(c===a.index){let v;a.type===2?v=new P(n,n.nextSibling,this,e):a.type===1?v=new a.ctor(n,a.name,a.strings,this,e):a.type===6&&(v=new Re(n,this,e)),this.v.push(v),a=o[++l]}c!==(a==null?void 0:a.index)&&(n=R.nextNode(),c++)}return r}m(e){let t=0;for(const i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class P{constructor(e,t,i,o){var r;this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cg=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=E(this,e,t),I(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==x&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):we(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==m&&I(this._$AH)?this._$AA.nextSibling.data=e:this.k(H.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=B.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(i);else{const n=new Se(r,this),c=n.p(this.options);n.m(i),this.k(c),this._$AH=n}}_$AC(e){let t=me.get(e.strings);return t===void 0&&me.set(e.strings,t=new B(e)),t}S(e){_e(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new P(this.M(L()),this.M(L()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class z{constructor(e,t,i,o,r){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=m}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let n=!1;if(r===void 0)e=E(this,e,t,0),n=!I(e)||e!==this._$AH&&e!==x,n&&(this._$AH=e);else{const c=e;let l,a;for(e=r[0],l=0;l<r.length-1;l++)a=E(this,c[i+l],t,l),a===x&&(a=this._$AH[l]),n||(n=!I(a)||a!==this._$AH[l]),a===m?e=m:e!==m&&(e+=(a!=null?a:"")+r[l+1]),this._$AH[l]=a}n&&!o&&this.C(e)}C(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Ce extends z{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===m?void 0:e}}const Ie=O?O.emptyScript:"";class ke extends z{constructor(){super(...arguments),this.type=4}C(e){e&&e!==m?this.element.setAttribute(this.name,Ie):this.element.removeAttribute(this.name)}}class Te extends z{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=E(this,e,t,0))!==null&&i!==void 0?i:m)===x)return;const o=this._$AH,r=e===m&&o!==m||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==m&&(o===m||r);r&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Re{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){E(this,e)}}const Be={L:"$lit$",P:A,V:se,I:1,N:Ee,R:Se,j:we,D:E,H:P,F:z,O:ke,W:Te,B:Ce,Z:Re},ve=window.litHtmlPolyfillSupport;ve==null||ve(B,P),((K=globalThis.litHtmlVersions)!==null&&K!==void 0?K:globalThis.litHtmlVersions=[]).push("2.2.6");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
