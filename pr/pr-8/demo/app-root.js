 ...
 */function*Qe(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}let B=class extends y{constructor(){super(...arguments),this.src="",this.alt=""}render(){return f`
  ...
  `;ee=$([k("resources-highlights")],ee);const et="INTERESTING GOVERNMENT DOCS",tt=[{id:"MH07D7178",title:"Fundraising for Social Change, Part One",image:"https://archive.org/services/img/MH07D7178"},{id:"CAT92272736",title:"Two keys for appraising forest fire fuels",image:"https://archive.org/services/img/CAT92272736"},{id:"CAT79708698031",title:"Hamburger\u2014Questions and Answers",image:"https://archive.org/services/img/CAT79708698031"},{id:"usda-posters",title:"U.S. Department of Agriculture Poster Collection",image:"https://archive.org/services/img/CAT31123678"},{id:"selectedpolishso00army",title:"Selected Polish songs",image:"https://archive.org/services/img/selectedpolishso00army"},{id:"blueprintforfutu9611unit",title:"Blueprint for the future",image:"https://archive.org/services/img/blueprintforfutu9611unit"},{id:"introductionlapt00albe",title:"Introduction \xE0 la p\xE2tisserie",image:"https://archive.org/services/img/introductionlapt00albe"},{id:"hintsonmountainl94youn",title:"Hints on mountain-lion trapping",image:"https://archive.org/services/img/hintsonmountainl94youn"},{id:"drylandfarmingin00cott",title:"Dry land farming in the Southwest",image:"https://archive.org/services/img/drylandfarmingin00cott"}],it=[{details:"Over 50 government organizations have had more than 2000 collections archived by Internet Archive's Archive-it service since 2006."},{details:"This is just the beginning. Democracy's Library will continue to grow and be updated over time. We'll be adding more information from all over the world, along with useful tools to help find and access what you need."}];let te=class extends y{render(){return f` <span><slot></slot></span> `}};te.styles=C`
    :host {
  ...
  `;te=$([k("ti-tle")],te);let ie=class extends y{render(){return f`<slot></slot>`}};ie.styles=C`
    :host {
      display: grid;
      gap: 0px 20px;
    }
  ...
  `;ie=$([k("arti-cle")],ie);let oe=class extends y{render(){return f`
  ...
  `;oe=$([k("welcome-header")],oe);let S=class extends y{constructor(){super(...arguments),this.carousel1=tt,this.didYouKnow=it,this.highlights=Xe,this.availableResources=void 0}firstUpdated(){this.fetchAvailableResources();const e=document.createElement("style");e.innerHTML=`
    @font-face {
      font-family: "Teko";
    ...
    /* End Carousel */
  `;$([N({type:Array})],S.prototype,"carousel1",void 0);$([N({type:Array})],S.prototype,"didYouKnow",void 0);$([N({type:Array})],S.prototype,"highlights",void 0);$([N({type:Object})],S.prototype,"availableResources",void 0);S=$([k("ia-democracys-library")],S);let se=class extends y{render(){return f`
