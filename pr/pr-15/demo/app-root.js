 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Ye}=je,we=()=>document.createComment(""),U=(s,e,t)=>{var i;const o=s._$AA.parentNode,r=e===void 0?s._$AB:e._$AA;if(t===void 0){const n=o.insertBefore(we(),r),c=o.insertBefore(we(),r);t=new Ye(n,c,s,s.options)}else{const n=t._$AB.nextSibling,c=t._$AM,a=c!==s;if(a){let l;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(l=s._$AU)!==c._$AU&&t._$AP(l)}if(n!==r||a){let l=t._$AA;for(;l!==n;){const v=l.nextSibling;o.insertBefore(l,r),l=v}}}return t},A=(s,e,t=s)=>(s._$AI(e,t),s),qe={},Ze=(s,e=qe)=>s._$AH=e,Je=s=>s._$AH,Q=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},Qe=Fe(class extends Ke{constructor(s){if(super(s),s.type!==Ve.CHILD)throw Error("repeat() can only be used in text expressions")}ht(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],r=[];let n=0;for(const c of s)o[n]=i?i(c,n):n,r[n]=t(c,n),n++;return{values:r,keys:o}}render(s,e,t){return this.ht(s,e,t).values}update(s,[e,t,i]){var o;const r=Je(s),{values:n,keys:c}=this.ht(e,t,i);if(!Array.isArray(r))return this.ut=c,n;const a=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],l=[];let v,h,d=0,p=r.length-1,u=0,m=n.length-1;for(;d<=p&&u<=m;)if(r[d]===null)d++;else if(r[p]===null)p--;else if(a[d]===c[u])l[u]=A(r[d],n[u]),d++,u++;else if(a[p]===c[m])l[m]=A(r[p],n[m]),p--,m--;else if(a[d]===c[m])l[m]=A(r[d],n[m]),U(s,l[m+1],r[d]),d++,m--;else if(a[p]===c[u])l[u]=A(r[p],n[u]),U(s,r[d],r[p]),p--,u++;else if(v===void 0&&(v=Ae(c,u,m),h=Ae(a,d,p)),v.has(a[d]))if(v.has(a[p])){const b=h.get(c[u]),V=b!==void 0?r[b]:null;if(V===null){const ce=U(s,r[d]);A(ce,n[u]),l[u]=ce}else l[u]=A(V,n[u]),U(s,r[d],V),r[b]=null;u++}else Q(r[p]),p--;else Q(r[d]),d++;for(;u<=m;){const b=U(s,l[m+1]);A(b,n[u]),l[u++]=b}for(;d<=p;){const b=r[d++];b!==null&&Q(b)}return this.ut=c,Ze(s,l),x}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Xe(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}let B=class extends ${constructor(){super(...arguments),this.src="",this.alt=""}render(){return f`
  ...
  `;se=y([C("welcome-header")],se);const X={link:"https://webservices.archive.org/wgw/",linkText:"Government websites of the world"};let k=class extends ${constructor(){super(...arguments),this.carousel1=it,this.didYouKnow=ot,this.highlights=et,this.availableResources=void 0}firstUpdated(){this.fetchAvailableResources();const e=document.createElement("style");e.innerHTML=`
    @font-face {
      font-family: "Teko";
        ...
        <arti-cle>
          ...
          <div class="factoid-link">
            <a
              ...
              @click=${()=>{var o;window.archive_analytics&&((o=window.archive_analytics)===null||o===void 0||o.send_event("DemocracysLibrary","FactoidLinkClicked",e.link))}}
              >${e.linkText}</a
            >
          </div>
        </arti-cle>
    ...
    /* End Carousel */
  `;y([N({type:Array})],k.prototype,"carousel1",void 0);y([N({type:Array})],k.prototype,"didYouKnow",void 0);y([N({type:Array})],k.prototype,"highlights",void 0);y([N({type:Object})],k.prototype,"availableResources",void 0);k=y([C("ia-democracys-library")],k);let re=class extends ${render(){return f`
