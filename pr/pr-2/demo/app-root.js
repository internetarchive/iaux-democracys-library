 ...
 */var V;((V=window.HTMLSlotElement)===null||V===void 0?void 0:V.prototype.assignedElements)!=null;let M=class extends f{constructor(){super(...arguments),this.src="",this.alt=""}render(){return m`
  ...
  `;q=u([R("ti-tle")],q);let $=class extends f{constructor(){super(...arguments),this.carousel1=Me,this.carousel2=He,this.didYouKnow=[],this.highlights=Te,this.fontSource=""}firstUpdated(){const e=document.createElement("style");e.innerHTML=`
    @font-face {
      font-family: "Teko";
    ...
    `}get bottomCarousel(){return m`
      ...
      <section id="carousel-2" class="carousel">
        ${this.carousel2.map((e,t)=>{const i=t%2===0?"yellow":"green";return this.carouselCard(e,i)})}
      </section>
    `}render(){return m`
      <section id="democracys-library-main">
        ...
        <resources-highlights>
          ...
          ${this.highlights.map((e,t)=>{const i=t%2===0?"yellow":"green";return this.createCard(e,i)})}
        </resources-highlights>
