 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Y;const G=window,R=G.trustedTypes,me=R?R.createPolicy("lit-html",{createHTML:s=>s}):void 0,_=`lit$${(Math.random()+"").slice(9)}$`,ae="?"+_,De=`<${ae}>`,H=document,M=(s="")=>H.createComment(s),I=s=>s===null||typeof s!="object"&&typeof s!="function",ke=Array.isArray,Ce=s=>ke(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",N=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ge=/-->/g,ve=/>/g,A=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),fe=/'/g,ye=/"/g,Se=/^(?:script|style|textarea|title)$/i,Be=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),f=Be(1),x=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),$e=new WeakMap,O=H.createTreeWalker(H,129,null,!1),Te=(s,e)=>{const t=s.length-1,i=[];let o,r=e===2?"<svg>":"",n=N;for(let a=0;a<t;a++){const l=s[a];let v,h,d=-1,u=0;for(;u<l.length&&(n.lastIndex=u,h=n.exec(l),h!==null);)u=n.lastIndex,n===N?h[1]==="!--"?n=ge:h[1]!==void 0?n=ve:h[2]!==void 0?(Se.test(h[2])&&(o=RegExp("</"+h[2],"g")),n=A):h[3]!==void 0&&(n=A):n===A?h[0]===">"?(n=o!=null?o:N,d=-1):h[1]===void 0?d=-2:(d=n.lastIndex-h[2].length,v=h[1],n=h[3]===void 0?A:h[3]==='"'?ye:fe):n===ye||n===fe?n=A:n===ge||n===ve?n=N:(n=A,o=void 0);const p=n===A&&s[a+1].startsWith("/>")?" ":"";r+=n===N?l+De:d>=0?(i.push(v),l.slice(0,d)+"$lit$"+l.slice(d)+_+p):l+_+(d===-2?(i.push(void 0),a):p)}const c=r+(s[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return[me!==void 0?me.createHTML(c):c,i]};class D{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let r=0,n=0;const c=e.length-1,a=this.parts,[l,v]=Te(e,t);if(this.el=D.createElement(l,i),O.currentNode=this.el.content,t===2){const h=this.el.content,d=h.firstChild;d.remove(),h.append(...d.childNodes)}for(;(o=O.nextNode())!==null&&a.length<c;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const d of o.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(_)){const u=v[n++];if(h.push(d),u!==void 0){const p=o.getAttribute(u.toLowerCase()+"$lit$").split(_),m=/([.?@])?(.*)/.exec(u);a.push({type:1,index:r,name:m[2],strings:p,ctor:m[1]==="."?Re:m[1]==="?"?He:m[1]==="@"?Pe:j})}else a.push({type:6,index:r})}for(const d of h)o.removeAttribute(d)}if(Se.test(o.tagName)){const h=o.textContent.split(_),d=h.length-1;if(d>0){o.textContent=R?R.emptyScript:"";for(let u=0;u<d;u++)o.append(h[u],M()),O.nextNode(),a.push({type:2,index:++r});o.append(h[d],M())}}}else if(o.nodeType===8)if(o.data===ae)a.push({type:2,index:r});else{let h=-1;for(;(h=o.data.indexOf(_,h+1))!==-1;)a.push({type:7,index:r}),h+=_.length-1}r++}}static createElement(e,t){const i=H.createElement("template");return i.innerHTML=e,i}}function E(s,e,t=s,i){var o,r,n,c;if(e===x)return e;let a=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const l=I(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==l&&((r=a==null?void 0:a._$AO)===null||r===void 0||r.call(a,!1),l===void 0?a=void 0:(a=new l(s),a._$AT(s,t,i)),i!==void 0?((n=(c=t)._$Co)!==null&&n!==void 0?n:c._$Co=[])[i]=a:t._$Cl=a),a!==void 0&&(e=E(s,a._$AS(s,e.values),a,i)),e}class Oe{constructor(e,t){this.u=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(e){var t;const{el:{content:i},parts:o}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:H).importNode(i,!0);O.currentNode=r;let n=O.nextNode(),c=0,a=0,l=o[0];for(;l!==void 0;){if(c===l.index){let v;l.type===2?v=new P(n,n.nextSibling,this,e):l.type===1?v=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(v=new Ue(n,this,e)),this.u.push(v),l=o[++a]}c!==(l==null?void 0:l.index)&&(n=O.nextNode(),c++)}return r}p(e){let t=0;for(const i of this.u)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class P{constructor(e,t,i,o){var r;this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cm=(r=o==null?void 0:o.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cm}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=E(this,e,t),I(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==x&&this.g(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ce(e)?this.k(e):this.g(e)}O(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}g(e){this._$AH!==g&&I(this._$AH)?this._$AA.nextSibling.data=e:this.T(H.createTextNode(e)),this._$AH=e}$(e){var t;const{values:i,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=D.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.p(i);else{const n=new Oe(r,this),c=n.v(this.options);n.p(i),this.T(c),this._$AH=n}}_$AC(e){let t=$e.get(e.strings);return t===void 0&&$e.set(e.strings,t=new D(e)),t}k(e){ke(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const r of e)o===t.length?t.push(i=new P(this.O(M()),this.O(M()),this,this.options)):i=t[o],i._$AI(r),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cm=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class j{constructor(e,t,i,o,r){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=g}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const r=this.strings;let n=!1;if(r===void 0)e=E(this,e,t,0),n=!I(e)||e!==this._$AH&&e!==x,n&&(this._$AH=e);else{const c=e;let a,l;for(e=r[0],a=0;a<r.length-1;a++)l=E(this,c[i+a],t,a),l===x&&(l=this._$AH[a]),n||(n=!I(l)||l!==this._$AH[a]),l===g?e=g:e!==g&&(e+=(l!=null?l:"")+r[a+1]),this._$AH[a]=l}n&&!o&&this.j(e)}j(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Re extends j{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===g?void 0:e}}const je=R?R.emptyScript:"";class He extends j{constructor(){super(...arguments),this.type=4}j(e){e&&e!==g?this.element.setAttribute(this.name,je):this.element.removeAttribute(this.name)}}class Pe extends j{constructor(e,t,i,o,r){super(e,t,i,o,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=E(this,e,t,0))!==null&&i!==void 0?i:g)===x)return;const o=this._$AH,r=e===g&&o!==g||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,n=e!==g&&(o===g||r);r&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Ue{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){E(this,e)}}const ze={P:"$lit$",A:_,M:ae,C:1,L:Te,R:Oe,D:Ce,V:E,I:P,H:j,N:He,U:Pe,B:Re,F:Ue},be=G.litHtmlPolyfillSupport;be==null||be(D,P),((Y=G.litHtmlVersions)!==null&&Y!==void 0?Y:G.litHtmlVersions=[]).push("2.4.0");const We=(s,e,t)=>{var i,o;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let n=r._$litPart$;if(n===void 0){const c=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;r._$litPart$=n=new P(e.insertBefore(M(),c),c,void 0,t!=null?t:{})}return n._$AI(s),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
